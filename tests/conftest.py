...
from ecoscope_earthranger_io_core.arrow import OBSERVATIONS_SCHEMA__EARTHRANGER_SLIM__V1
...
def _create_mock_observations_record_batch(
    ...
    nrecords: int = 1000,
    schema: pyarrow.Schema = OBSERVATIONS_SCHEMA__EARTHRANGER_SLIM__V1,
) -> pyarrow.RecordBatch:
    pylist = []
